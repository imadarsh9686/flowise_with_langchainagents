    ...
    if submit_button and user_input:
        ...
        if selected_api_index == 2:
            ...
            answer1 = conversation1.predict(
                input=f"For the question{user_input} just answer it from this content given only give the content answer  {chatlist} if u dont feel answer is correct or do not find the answer in the content strictly give strictly output with word No donot give any reason just give output with word No so with that keyword No next agent activate to answer the query just give output No if you donot found the answer ")
